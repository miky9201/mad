  ...
  return (
    <section id="agence">
      ...
      <p>
        ...
        intérieure. <br />
        Elle gère le projet dans sa totalité : de la définition du concept, à la
        planification / gestion des budgets / élaboration de plans, jusqu’à la
      ...
      <p>
        ...
        permets d’appréhender des travaux avec de hauts niveaux d’exigence. Nous
        disposons d’un carnet d’adresse d’entreprises et d’artisans de
        confiance, habitués aux projets rigoureux, pouvant nous accompagner sur
        notre projet commun.
      </p>
    </section>
  );
